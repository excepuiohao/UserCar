...
<body>
	...
	<div id="background">
		...
		<table height="80px" width="1550px">
			<tr>
				<td class="rightborder" align="center"><a href="User_First.jsp"
					target="right"><div id="div01">
							<img src="../img/SystemFirst.png" /> <br /> <font>系统首页</font>
						</div> </a></td>
				<td class="rightborder" align="center"><a href="User_Second_Lift.jsp" target="right">
						<div>
		...
		<div id="div2"></div>
		<div id="div1">
			<font color="#FFFFFF">当前用户：（${emp.getEmp_name()}）</font> &nbsp;&nbsp; <a href="UserLogin.jsp">退出系统</a>
		</div>
		<!--空白的-->
		<div id="div3">
			<iframe scrolling="auto" rameborder="0" src="User_First.jsp"
