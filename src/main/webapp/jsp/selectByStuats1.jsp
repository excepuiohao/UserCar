	...
	<form action="selectByStuats1">
		...
		<table align="center" width="650px">
			<tr>
				...
				<td bgcolor="#F3F3F3" align="center" width="70px">用车部门</td>
				<td bgcolor="#F3F3F3" align="center" width="100px">申请车辆类型</td>
				<td bgcolor="#F3F3F3" align="center" width="100px">申请用车时间</td>
				<td bgcolor="#F3F3F3" align="center" width="80px">申请单状态</td>
			...
			<tr>
				...
				<td bgcolor="#F3F3F3" align="center"><a href="selectByappId?app_id=<%=apply.getApp_id()%>">修改</a><a
					href="deleteApply?app_id=<%=apply.getApp_id()%>"><input type="hidden" value="<%=apply.getApp_id()%>" name="app_id">撤销申请</a></td>
